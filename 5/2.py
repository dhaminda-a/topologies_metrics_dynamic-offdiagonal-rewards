##Ten local communities with an agent population of 50 were created using the topology barabasi_albert_graph.
##In addition, a global community was created by union_all of the generated ten local community graphs.
##Separation degree of the network was decreased by adding edges between the ten local community graphs of the global community.
##The simulation was executed for 100 times and results were averaged. Norm 1 is choosing action 0, 0 by the two agents; norm 2 is when actions 1,1 are chosen.
...
##                    a1c += 1
            ...
            #print("reward_total_in_the_iteration: ", reward_total_in_the_iteration)
            #print("len(self.agents_map): ", len(self.agents_map))
            #print("Iteration: ", iteration)
            #print("self.average_reward[iteration]: ", self.average_reward[iteration])
...
##        with open('diversity_array_SD2_run'+str(abc)+'.json','w') as resF:
##            #print ("s.diversity_array: ", s.diversity_array)
##            resF.write(json.dumps(s.diversity_array))

##        average_community_averagepayoff_array = []
##        i = 0
##        j = len(s1.average_reward)
##        while i < j:
##            average_community_averagepayoff_array.append((s1.average_reward[i] + s2.average_reward[i] + s3.average_reward[i] + s4.average_reward[i] + s5.average_reward[i]
##                                                   + s6.average_reward[i] + s7.average_reward[i] + s8.average_reward[i] + s9.average_reward[i] + s10.average_reward[i]) /10)
##            i += 1

        average_community_averagepayoff_array = []
        i = 0
        j = len(s.average_reward)
        while i < j:
            average_community_averagepayoff_array.append(s.average_reward[i])
            i += 1
            
        with open('average_community_averagepayoff_array_SD2_'+str(abc)+'.json','w') as resF:
            print ("s.average_reward: ", average_community_averagepayoff_array)
            resF.write(json.dumps(average_community_averagepayoff_array))
        ...
        with open('average_conformity_SD2_run'+str(abc)+'.json','w') as resF:
        ...
        with open('norm1_frequency_array_lc1_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc1))
        with open('norm1_frequency_array_lc2_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc2))
        with open('norm1_frequency_array_lc3_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc3))
        with open('norm1_frequency_array_lc4_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc4))
        with open('norm1_frequency_array_lc5_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc5))
        with open('norm1_frequency_array_lc6_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc6))
        with open('norm1_frequency_array_lc7_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc7))
        with open('norm1_frequency_array_lc8_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc8))
        with open('norm1_frequency_array_lc9_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc9))
        with open('norm1_frequency_array_lc10_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc10))

        with open('norm2_frequency_array_lc1_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc1))
        with open('norm2_frequency_array_lc2_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc2))
        with open('norm2_frequency_array_lc3_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc3))
        with open('norm2_frequency_array_lc4_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc4))
        with open('norm2_frequency_array_lc5_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc5))
        with open('norm2_frequency_array_lc6_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc6))
        with open('norm2_frequency_array_lc7_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc7))
        with open('norm2_frequency_array_lc8_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc8))
        with open('norm2_frequency_array_lc9_SD2_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc9))
        with open('norm2_frequency_array_lc10_SD2_'+str(abc)+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    for filename in listdir('.'):
            if filename.__contains__("average_conformity_SD2_run"):
    ...
    with open('average_runs_conformity_SD2'+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    with open('average_conformity_lc1_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc2_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc3_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc4_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc5_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc6_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc7_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc8_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc9_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc10_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
...
# ----------------------------------------------------------------------------------------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc1_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc1_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc2_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc2_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc3_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc3_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc4_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc4_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc5_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc5_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc6_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc6_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc7_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc7_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc8_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc8_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc9_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc9_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc10_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc10_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc1_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc1_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc2_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc2_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc3_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc3_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc4_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc4_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc5_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc5_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc6_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc6_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc7_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc7_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc8_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc8_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc9_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc9_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc10_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc10_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))

   # ----
    results = []
    for filename in listdir("."):
            if filename.__contains__("average_community_averagepayoff_array_SD2"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
                                    results.append(res)
    ...
    # dump the average_runs_conformity_array in json file
    with open('average_runs_averagepayoff_SD2'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #print ("average_runs_conformity_array: ", average_runs_conformity_array)


    print("SD2 - Average Degree of Network = accumulated_average_degree/number of runs: ", accumulated_average_degree/100)
    print("SD2 - Separation Degree of Network = accumulated_separation_degree/number of runs: ", accumulated_separation_degree/100)
