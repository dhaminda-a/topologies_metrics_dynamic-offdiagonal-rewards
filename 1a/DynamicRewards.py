# Ten local community networks with a population size of 50 agents were generated using the random graph generator,
# random_regular_graph. Agents learn using Q-Learning algorithm (exploration rate: 0.1, learning rate: 0.5).
# Conformity is the average conformity of all ten local communities. Number of actions = 4 (action 0, 1, 2, 3).
...
##                    a1c += 1
                if(iteration < (self.number_of_iterations/2)):
                    ...
                    #print ("get_reward_alternative")
                    self.agents_map[counter].reward = self.agents_map[counter].get_reward_alternative(agent1_action, agent2_action)
                    self.agents_map[z.agentid-1].reward = self.agents_map[z.agentid-1].get_reward_alternative(agent1_action, agent2_action)
...
class Agent:
    ...
    def get_reward(self, agent1action, agent2action):
        if((agent1action == 0 and agent2action == 0) or (agent1action == 1 and agent2action == 1)):
            return 1
        else:
            return -1


     # Alternative reward function to return the reward based on the action of agent 1 and agent 2.
    def get_reward_alternative(self, agent1action, agent2action):
        if((agent1action == 2 and agent2action == 2) or (agent1action == 3 and agent2action == 3)):
            return 1
        else:
            return -1
...
##        plt.show()
        ...
        with open('average_conformity_DR_run'+str(abc)+'.json','w') as resF:
        ...
        with open('diversity_DR_run'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.diversity_array))

        with open('norm1_frequency_array_lc1_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc1))
        with open('norm1_frequency_array_lc2_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc2))
        with open('norm1_frequency_array_lc3_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc3))
        with open('norm1_frequency_array_lc4_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc4))
        with open('norm1_frequency_array_lc5_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc5))
        with open('norm1_frequency_array_lc6_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc6))
        with open('norm1_frequency_array_lc7_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc7))
        with open('norm1_frequency_array_lc8_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc8))
        with open('norm1_frequency_array_lc9_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc9))
        with open('norm1_frequency_array_lc10_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc10))

        with open('norm2_frequency_array_lc1_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc1))
        with open('norm2_frequency_array_lc2_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc2))
        with open('norm2_frequency_array_lc3_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc3))
        with open('norm2_frequency_array_lc4_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc4))
        with open('norm2_frequency_array_lc5_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc5))
        with open('norm2_frequency_array_lc6_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc6))
        with open('norm2_frequency_array_lc7_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc7))
        with open('norm2_frequency_array_lc8_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc8))
        with open('norm2_frequency_array_lc9_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc9))
        with open('norm2_frequency_array_lc10_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc10))

        with open('norm3_frequency_array_lc1_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc1))
        with open('norm3_frequency_array_lc2_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc2))
        with open('norm3_frequency_array_lc3_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc3))
        with open('norm3_frequency_array_lc4_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc4))
        with open('norm3_frequency_array_lc5_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc5))
        with open('norm3_frequency_array_lc6_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc6))
        with open('norm3_frequency_array_lc7_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc7))
        with open('norm3_frequency_array_lc8_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc8))
        with open('norm3_frequency_array_lc9_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc9))
        with open('norm3_frequency_array_lc10_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc10))

        with open('norm4_frequency_array_lc1_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc1))
        with open('norm4_frequency_array_lc2_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc2))
        with open('norm4_frequency_array_lc3_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc3))
        with open('norm4_frequency_array_lc4_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc4))
        with open('norm4_frequency_array_lc5_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc5))
        with open('norm4_frequency_array_lc6_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc6))
        with open('norm4_frequency_array_lc7_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc7))
        with open('norm4_frequency_array_lc8_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc8))
        with open('norm4_frequency_array_lc9_DR_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc9))
        with open('norm4_frequency_array_lc10_DR_'+str(abc)+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    for filename in listdir('.'):
            if filename.__contains__("average_conformity_DR_run"):
    ...
    with open('average_runs_conformity_DR'+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    with open('average_conformity_lc1_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc2_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc3_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc4_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc5_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc6_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc7_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc8_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc9_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc10_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
...
# ----------------------------------------------------------------------------------------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("diversity_DR_run"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
                                    results.append(res)
    ...
    with open('average_runs_diversity_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
...
# ----------------------------------------------------------------------------------------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc1_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc1_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc2_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc2_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc3_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc3_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc4_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc4_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc5_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc5_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc6_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc6_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc7_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc7_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc8_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc8_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc9_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc9_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc10_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc10_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc1_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc1_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc2_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc2_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc3_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc3_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc4_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc4_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc5_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc5_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc6_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc6_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc7_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc7_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc8_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc8_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc9_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc9_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc10_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc10_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc1_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc1_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc2_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc2_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc3_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc3_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc4_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc4_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc5_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc5_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc6_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc6_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc7_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc7_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc8_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc8_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc9_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc9_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc10_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc10_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc1_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc1_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc2_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc2_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc3_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc3_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc4_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc4_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc5_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc5_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc6_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc6_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc7_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc7_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc8_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc8_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc9_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc9_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc10_DR"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc10_DR'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))


    print("Dynamic Rewards - Average Degree of Network = accumulated_average_degree/number of runs: ", accumulated_average_degree/100)
    print("Dynamic Rewards - Separation Degree of Network = accumulated_separation_degree/number of runs: ", accumulated_separation_degree/100)
