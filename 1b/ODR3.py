...
class Simulation:
    def __init__(self, graph):
        ...
        for i in range(0, self.num_agents):
            ...
            agent_id = agent_id + 1
        #nx.ODR3aw_networkx(self.graph,with_labels=True,node_size=500)
        #plt.show()
...
class Agent:
    ...
    def get_offdiagonal_reward(self, agent1action, agent2action):
        if((agent1action == 0 and agent2action == 0) or (agent1action == 1 and agent2action == 1) or (agent1action == 2 and agent2action == 2) or (agent1action == 3 and agent2action == 3)):
            return 2
        elif((agent1action == 0 and agent2action == 1) or (agent1action == 1 and agent2action == 0) or (agent1action == 1 and agent2action == 2) or (agent1action == 2 and agent2action == 1)
             or (agent1action == 2 and agent2action == 3) or (agent1action == 3 and agent2action == 2)):
            return 1
        else:
            return -2 
...
##        plt.show()
        ...
        with open('average_conformity_ODR3_run'+str(abc)+'.json','w') as resF:
        ...
        with open('diversity_ODR3_run'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.diversity_array))

        with open('norm1_frequency_array_lc1_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc1))
        with open('norm1_frequency_array_lc2_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc2))
        with open('norm1_frequency_array_lc3_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc3))
        with open('norm1_frequency_array_lc4_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc4))
        with open('norm1_frequency_array_lc5_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc5))
        with open('norm1_frequency_array_lc6_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc6))
        with open('norm1_frequency_array_lc7_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc7))
        with open('norm1_frequency_array_lc8_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc8))
        with open('norm1_frequency_array_lc9_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc9))
        with open('norm1_frequency_array_lc10_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc10))

        with open('norm2_frequency_array_lc1_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc1))
        with open('norm2_frequency_array_lc2_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc2))
        with open('norm2_frequency_array_lc3_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc3))
        with open('norm2_frequency_array_lc4_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc4))
        with open('norm2_frequency_array_lc5_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc5))
        with open('norm2_frequency_array_lc6_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc6))
        with open('norm2_frequency_array_lc7_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc7))
        with open('norm2_frequency_array_lc8_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc8))
        with open('norm2_frequency_array_lc9_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc9))
        with open('norm2_frequency_array_lc10_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc10))

        with open('norm3_frequency_array_lc1_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc1))
        with open('norm3_frequency_array_lc2_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc2))
        with open('norm3_frequency_array_lc3_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc3))
        with open('norm3_frequency_array_lc4_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc4))
        with open('norm3_frequency_array_lc5_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc5))
        with open('norm3_frequency_array_lc6_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc6))
        with open('norm3_frequency_array_lc7_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc7))
        with open('norm3_frequency_array_lc8_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc8))
        with open('norm3_frequency_array_lc9_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc9))
        with open('norm3_frequency_array_lc10_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm3_frequency_array_lc10))

        with open('norm4_frequency_array_lc1_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc1))
        with open('norm4_frequency_array_lc2_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc2))
        with open('norm4_frequency_array_lc3_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc3))
        with open('norm4_frequency_array_lc4_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc4))
        with open('norm4_frequency_array_lc5_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc5))
        with open('norm4_frequency_array_lc6_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc6))
        with open('norm4_frequency_array_lc7_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc7))
        with open('norm4_frequency_array_lc8_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc8))
        with open('norm4_frequency_array_lc9_ODR3_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm4_frequency_array_lc9))
        with open('norm4_frequency_array_lc10_ODR3_'+str(abc)+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    for filename in listdir('.'):
            if filename.__contains__("average_conformity_ODR3_run"):
    ...
    with open('average_runs_conformity_ODR3'+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    with open('average_conformity_lc1_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc2_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc3_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc4_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc5_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc6_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc7_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc8_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc9_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc10_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
...
# ----------------------------------------------------------------------------------------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("diversity_ODR3_run"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
                                    results.append(res)
    ...
    with open('average_runs_diversity_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
...
# ----------------------------------------------------------------------------------------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc1_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc1_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc2_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc2_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc3_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc3_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc4_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc4_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc5_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc5_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc6_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc6_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc7_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc7_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc8_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc8_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc9_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc9_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc10_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc10_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc1_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc1_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc2_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc2_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc3_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc3_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc4_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc4_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc5_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc5_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc6_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc6_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc7_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc7_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc8_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc8_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc9_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc9_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc10_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc10_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc1_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc1_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc2_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc2_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc3_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc3_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc4_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc4_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc5_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc5_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc6_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc6_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc7_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc7_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc8_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc8_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc9_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc9_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm3_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm3_frequency_array_lc10_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms3_frequency_lc10_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc1_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc1_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc2_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc2_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc3_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc3_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc4_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc4_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc5_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc5_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc6_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc6_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc7_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc7_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc8_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc8_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc9_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc9_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm4_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm4_frequency_array_lc10_ODR3"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms4_frequency_lc10_ODR3'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))


    print("ODR3 - Average Degree of Network = accumulated_average_degree/number of runs: ", accumulated_average_degree/100)
    print("ODR3 - Separation Degree of Network = accumulated_separation_degree/number of runs: ", accumulated_separation_degree/100)
