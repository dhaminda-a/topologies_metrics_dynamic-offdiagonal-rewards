##Ten local communities with an agent population of 50 were created using the topology connected_watts_strogatz_graph.
##In addition, a global community was created by union_all of the generated ten local community graphs.
##Separation degree of the network was decreased by probabilistically adding edges between the ten local community graphs of the global community.
...
##        G10 = nx.extended_barabasi_albert_graph(population_size, 42, 0.1, 0.1)
    ...
    for filename in listdir('.'):
            if filename.__contains__("diversity_array_SD2_run"):
    ...
    with open('average_runs_diversity_SD2'+'.json','w') as resF:
