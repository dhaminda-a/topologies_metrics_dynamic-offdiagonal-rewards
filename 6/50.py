...
##        with open('diversity_array_CommunitySize50_run'+str(abc)+'.json','w') as resF:
...
##            resF.write(json.dumps(s.diversity_array))
        ...
        with open('average_conformity_CommunitySize50_run'+str(abc)+'.json','w') as resF:
        ...
        with open('norm1_frequency_array_lc1_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc1))
        with open('norm1_frequency_array_lc2_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc2))
        with open('norm1_frequency_array_lc3_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc3))
        with open('norm1_frequency_array_lc4_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc4))
        with open('norm1_frequency_array_lc5_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc5))
        with open('norm1_frequency_array_lc6_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc6))
        with open('norm1_frequency_array_lc7_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc7))
        with open('norm1_frequency_array_lc8_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc8))
        with open('norm1_frequency_array_lc9_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc9))
        with open('norm1_frequency_array_lc10_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc10))

        with open('norm2_frequency_array_lc1_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc1))
        with open('norm2_frequency_array_lc2_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc2))
        with open('norm2_frequency_array_lc3_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc3))
        with open('norm2_frequency_array_lc4_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc4))
        with open('norm2_frequency_array_lc5_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc5))
        with open('norm2_frequency_array_lc6_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc6))
        with open('norm2_frequency_array_lc7_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc7))
        with open('norm2_frequency_array_lc8_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc8))
        with open('norm2_frequency_array_lc9_CommunitySize50_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc9))
        with open('norm2_frequency_array_lc10_CommunitySize50_'+str(abc)+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    for filename in listdir('.'):
            if filename.__contains__("average_conformity_CommunitySize50_run"):
    ...
    with open('average_runs_conformity_CommunitySize50'+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    with open('average_conformity_lc1_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc2_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc3_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc4_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc5_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc6_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc7_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc8_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc9_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------------------------------------------------
    results = []
    #destdir = 'json/'
    ...
    with open('average_conformity_lc10_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
...
# ----------------------------------------------------------------------------------------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc1_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc1_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc2_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc2_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc3_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc3_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc4_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc4_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc5_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc5_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc6_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc6_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc7_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc7_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc8_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc8_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc9_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc9_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc10_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc10_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc1_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc1_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc2_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc2_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc3_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc3_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc4_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc4_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc5_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc5_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc6_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc6_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc7_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc7_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc8_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc8_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc9_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc9_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc10_CommunitySize50"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc10_CommunitySize50'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))


    print("CommunitySize50 - Average Degree of Network = accumulated_average_degree/number of runs: ", accumulated_average_degree/100)
    print("CommunitySize50 - Separation Degree of Network = accumulated_separation_degree/number of runs: ", accumulated_separation_degree/100)
