...
if __name__ == "__main__":
    ...
    plt.figure()
    plt.plot(average_runs_conformity_array_SD2, label = 'Separation Degree - 0.92', linewidth=0.75, color = 'red')
    plt.plot(average_runs_conformity_array_SD1, label = 'Separation Degree - 0.54', linewidth=0.75, color = 'green')
    #plt.plot(average_runs_conformity_array_SD1, linewidth=0.75, color = 'green')

    plt.ylim(ymin=0)
    plt.xlabel("Iterations", fontsize=15)
    plt.ylabel("Conformity", fontsize=15)
    plt.title("Dynamics of Conformity in Instance Networks (Average to 100 runs)", fontsize=20)
