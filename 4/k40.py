...
##        G10 = nx.extended_barabasi_albert_graph(population_size, 42, 0.1, 0.1)
        ...
        with open('diversity_array_k40_run'+str(abc)+'.json','w') as resF:
            #print ("s.diversity_array: ", s.diversity_array)
            resF.write(json.dumps(s.diversity_array))


        with open('norm1_frequency_array_lc1_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc1))
        with open('norm1_frequency_array_lc2_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc2))
        with open('norm1_frequency_array_lc3_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc3))
        with open('norm1_frequency_array_lc4_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc4))
        with open('norm1_frequency_array_lc5_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc5))
        with open('norm1_frequency_array_lc6_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc6))
        with open('norm1_frequency_array_lc7_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc7))
        with open('norm1_frequency_array_lc8_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc8))
        with open('norm1_frequency_array_lc9_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc9))
        with open('norm1_frequency_array_lc10_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm1_frequency_array_lc10))

        with open('norm2_frequency_array_lc1_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc1))
        with open('norm2_frequency_array_lc2_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc2))
        with open('norm2_frequency_array_lc3_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc3))
        with open('norm2_frequency_array_lc4_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc4))
        with open('norm2_frequency_array_lc5_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc5))
        with open('norm2_frequency_array_lc6_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc6))
        with open('norm2_frequency_array_lc7_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc7))
        with open('norm2_frequency_array_lc8_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc8))
        with open('norm2_frequency_array_lc9_k40_'+str(abc)+'.json','w') as resF:
            resF.write(json.dumps(s.norm2_frequency_array_lc9))
        with open('norm2_frequency_array_lc10_k40_'+str(abc)+'.json','w') as resF:
    ...
    for filename in listdir('.'):
            if filename.__contains__("diversity_array_k40_run"):
    ...
    with open('average_runs_diversity_k40'+'.json','w') as resF:
...
# ----------------------------------------------------------------------------------------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc1_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc1_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc2_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc2_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc3_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc3_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc4_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc4_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc5_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc5_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc6_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc6_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc7_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc7_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc8_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc8_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc9_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc9_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm1_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm1_frequency_array_lc10_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms1_frequency_lc10_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    ...
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc1_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc1_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc2 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc2_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc2_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc3 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc3_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc3_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc4 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc4_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc4_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc5 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc5_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc5_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc6 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc6_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc6_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc7 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc7_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc7_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc8 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc8_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc8_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc9 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc9_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc9_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))
    #-----------------
    results_norm2_frequency_lc10 = []
    #destdir = 'json/'
    for filename in listdir('.'):
            if filename.__contains__("norm2_frequency_array_lc10_k40"):
                    with open(filename,'r') as resF:
                            for line in resF:
                                    res = json.loads(line)
    ...
    with open('average_runs_norms2_frequency_lc10_k40'+'.json','w') as resF:
   	 resF.write(json.dumps(a_mean.tolist()))

    print("k40 - Average Degree of Network = accumulated_average_degree/number of runs: ", accumulated_average_degree/100)
    print("k40 - Separation Degree of Network = accumulated_separation_degree/number of runs: ", accumulated_separation_degree/100)
